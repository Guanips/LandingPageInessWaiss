	...
	if (id_consulta_MP != null) {
		try {
			...
			if (response.status == "approved") {
				...
				res.send(
					'<div class="contenedorContenidoServer"><p class="tituloExito">¡Compra Exitosa!</p><p class="cuerpoExito">Muchas gracias por tu compra, por favor, envie el comprobante de pago o de transferencia a el siguiente whatsapp: </p><a aria-label="Chat on WhatsApp" href="https://wa.me/+5491140627516"> <img alt="Chat on WhatsApp" src="/assets/img/WhatsAppButtonGreenMedium.svg"/></a><div/>'
				);
		...
		try {
			...
			if (response.data.state == "completed") {
				...
				res.send(
					'<div class="contenedorContenidoServer"><p class="tituloExito">¡Compra Exitosa!</p><p class="cuerpoExito">Muchas gracias por tu compra, por favor, envie el comprobante de pago o de transferencia a el siguiente whatsapp: </p><a aria-label="Chat on WhatsApp" href="https://wa.me/+5491125366995"> <img alt="Chat on WhatsApp" src="/assets/img/WhatsAppButtonGreenMedium.svg"/></a><div/>'
				);
			} else {
...
app.post("/create_preference", async (req, res) => {
	...
	try {
		const body = {
			...
			back_urls: {
				success: "https://ineswaiss.com.ar/Marketplace/resultadoCompra",
				failure: "https://ineswaiss.com.ar/Marketplace/resultadoCompra",
				pending: "https://ineswaiss.com.ar/Marketplace/resultadoCompra",
			},
