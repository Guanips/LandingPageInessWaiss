...
const TarjetaProd = (props) => {
    ...
    const obtenerPrecios = async () => {
        try {
            const response = await axios.get("https://server-marketplace-waiss.rj.r.appspot.com/get_precios")
    ...
    const createPreference = async () => {
        try {
            const response = await axios.post("https://server-marketplace-waiss.rj.r.appspot.com/create_preference", {
                title: props.titulo,
                quantity: 1,
